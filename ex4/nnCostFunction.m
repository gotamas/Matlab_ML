...
%         computed in ex4.m
%predict copy
% %X-ben a minták soronként
% Z_2=X*Theta1';      %Z_2:5000*25 %minták soronként
% m_2 = size(Z_2, 1); %m_2=5000*1 
%  %Z_2=5000*26
% A_2=sigmoid(Z_2); %A_2=5000*26 %minták soronként
% A_2 = [ones(m_2, 1) A_2]; 
% Z_3=A_2*Theta2'; %5000x10 %minták soronként
% A_3=sigmoid(Z_3); %minták soronként
% h_x=A_3;
% 
% 
% Y=zeros(size(h_x));
